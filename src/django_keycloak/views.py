    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        authorization_url = self.request.realm.client.openid_api_client\
            .authorization_url(
                ...
                scope='openid profile email phone', # modified from 'openid given_name family_name email' to fix invaild scopes issue https://github.com/oauth2-proxy/oauth2-proxy/issues/1448
...
class LoginComplete(RedirectView):
    ...
    def get(self, *args, **kwargs):
        ...
        try:
            ...
            # Manejar la falta de un objeto Nonce (puede redirigir al usuario a una página de error, por ejemplo)
            return HttpResponseRedirect(reverse('keycloak_login'))
